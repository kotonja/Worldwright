...
/** Compares Unicode code points without locale-dependent behavior. */
...
/** Returns the first deterministic reason an unknown value is not ordinary JSON data. */
...
/** Canonical JSON uses code-point-sorted keys, two spaces, and exactly one final line feed. */
...
/** Recursively freezes a public contract descriptor, including TypeBox symbol metadata. */
